      ...
      <div className="grid lg:grid-cols-5 gap-6">
        <div className="lg:col-span-2 space-y-4">
          <div className="glass-card rounded-2xl p-6 space-y-5">
            ...
            <SliderField label="Your gross annual income" prefix="ÃÂÃÂÃÂÃÂ£" value={income} min={15_000} max={300_000} step={1_000} onChange={setIncome} />
            <SliderField label="Partner annual income" prefix="ÃÂÃÂÃÂÃÂ£" value={partner} min={0} max={300_000} step={1_000} onChange={setPartner} />
        ...
        <div className="lg:col-span-3 space-y-4">
          <div className="glass-card rounded-2xl p-6 bg-gradient-to-br from-accent/10 to-transparent border-accent/30">
            ...
            <p className="text-xs text-muted-foreground mt-2">
              Property price you can target: <span className="font-semibold text-foreground">{formatGBP(result.maxPropertyValue)}</span> ÃÂÃÂÃÂÃÂ· Loan-to-income {lti.toFixed(2)}x
            </p>
          </div>
          ...
          <ShareCalculation
            ...
            intro={`Income ${formatGBP(totalIncome)} ÃÂÃÂÃÂÃÂ· Deposit ${formatGBP(deposit)} ÃÂÃÂÃÂÃÂ· Rate ${rate.toFixed(2)}%`}
            summary={[
