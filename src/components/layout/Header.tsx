...
export const Header = () => (
  <header className="sticky top-0 z-40 px-4 pt-4">
    <div className="max-w-6xl mx-auto glass-card rounded-2xl px-4 sm:px-6 py-3 flex items-center justify-between">
      <Link to="/" className="flex items-center gap-2 group" aria-label="RepayWise home">
        <img src="/favicon.png" alt="RepayWise logo" width={32} height={32} className="size-8 rounded-lg" />
